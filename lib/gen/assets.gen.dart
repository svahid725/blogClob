...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/ActiveArticle.png
  AssetGenImage get activeArticle =>
      const AssetGenImage('assets/img/icons/ActiveArticle.png');

  /// File path: assets/img/icons/ActiveHome.png
  AssetGenImage get activeHome =>
      const AssetGenImage('assets/img/icons/ActiveHome.png');

  /// File path: assets/img/icons/ActiveMenu.png
  AssetGenImage get activeMenu =>
      const AssetGenImage('assets/img/icons/ActiveMenu.png');

  /// File path: assets/img/icons/ActiveSearch.png
  AssetGenImage get activeSearch =>
      const AssetGenImage('assets/img/icons/ActiveSearch.png');
